...
type Order struct {
	...
	OrderNumber     string    `db:"order_number" json:"order_number" example:"ORD-2026-0001"` // Unique order identifier
...
type CreateOrderRequest struct {
	OrderNumber     string `json:"order_number" example:"ORD-2026-0001" binding:"required"` // Unique order identifier
